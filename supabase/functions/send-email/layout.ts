...
`<tr><td class="email-head" style="background:#7E57DF;padding:28px 32px;text-align:center;">`+
`<a href="${url}" class="email-brand" style="text-decoration:none;display:inline-block;color:#ffffff;font-size:24px;font-weight:800;letter-spacing:.5px;">`+
